...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-700 pt-10 pb-6 mt-16 overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 overflow-hidden">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#">About EchoSwap Group</a></li>
              <li><a href="#">Careers</a></li>
              <li><a href="#">Contact Us</a></li>
              <li><a href="#">EchoSwapPeople</a></li>
            </ul>
          </div>
        ...
        <div className="mt-10 border-t pt-4 text-center text-sm text-gray-500">
          <p className="leading-relaxed">Other Countries: Pakistan - South Africa - Indonesia</p>
